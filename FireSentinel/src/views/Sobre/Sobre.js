    ...
    return (
        <View style={estiloSobre.container}>
            <View>
                ...
                <Text style={estiloSobre.textoA}>O aquecimento global continua a aumentar, uma das razões são os grandes incêndios sem controle
            ...
            evitando danos à bens públicos e privados e a vida dos cidadãos. Nosso primeiro passo, já concluído, foi realizar
            ...
            mundo, conexão com nossos alarmes de incêndio e opções para denunciar focos de fogo e ligar para as autoridades locais.</Text>
            <Text style={estiloSobre.textoA}>Criado e desenvolvido por: Gabriel Garske, Keisy Fernanda e Danilo Calssi - Estudantes da ETEC de Hortolândia, cursando o terceiro ano do ensino médio integrado ao tecnico de desenvolvimento de sistemas.</Text>
